...
models = dict(
    ...
    sgd=SGDClassifier(random_state=seed, penalty='l1', loss='log', alpha=1e-5),
    bnb=BernoulliNB(),
...
models = dict(
    ...
    ridge=RidgeClassifier(random_state=seed, alpha=5),
    sgd=SGDClassifier(random_state=seed, penalty='l1', loss='log', alpha=1e-5, n_jobs=N_CLS),
