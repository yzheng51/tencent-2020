...
models = dict(
    ...
    svm=LinearSVC(random_state=seed, C=1),
    pac=PassiveAggressiveClassifier(random_state=seed, loss='squared_hinge', C=0.001),
    ridge=RidgeClassifier(random_state=seed, alpha=0.1),
    sgd=SGDClassifier(random_state=seed, loss='log'),
    bnb=BernoulliNB(),
...
models = dict(
    ...
    pac=PassiveAggressiveClassifier(random_state=seed, loss='squared_hinge', C=0.0001, n_jobs=N_CLS),
    ridge=RidgeClassifier(random_state=seed),
    sgd=SGDClassifier(random_state=seed, loss='log', n_jobs=N_CLS),
    bnb=BernoulliNB(),
