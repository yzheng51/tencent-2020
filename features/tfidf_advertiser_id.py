...
models = dict(
    ...
    pac=PassiveAggressiveClassifier(random_state=seed, loss='squared_hinge', C=0.01, n_jobs=N_CLS),
    ridge=RidgeClassifier(random_state=seed, alpha=5),
    sgd=SGDClassifier(random_state=seed, penalty='l1', loss='log', alpha=1e-6, n_jobs=N_CLS),
